...
AMW: A couple things: I fixed an improperly placed `dplyr` import in the Gutselli function. You'll want to make sure you re-build your package and push to GitHub. You also might consider making some NA values default in the clean_function. 
